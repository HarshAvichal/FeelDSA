...
import { selectionSort } from '../utils/algorithms/sorting';
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">Selection Sort</h1>
            ...
            <div className="container mx-auto px-4 py-6">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div>
                  ...
                  <p className="text-gray-700 leading-relaxed">{selectionSort.description}</p>
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between">
                      ...
                      <span className="font-mono font-medium text-gray-900">{selectionSort.complexity.time}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">Space:</span>
                      <span className="font-mono font-medium text-gray-900">{selectionSort.complexity.space}</span>
                    </div>
                  </div>
            ...
            <div className="card w-full">
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-base sm:text-lg font-semibold">Learn Selection Sort</span>
                </div>
                ...
                <div className="mt-3 sm:mt-4 space-y-3 sm:space-y-4">
                  <div>
                    ...
                    <ul className="text-sm text-gray-600 space-y-1">
                      {selectionSort.explanation.howItWorks.map((step, index) => (
                  ...
                  <div>
                    ...
                    <ul className="text-sm text-gray-600 space-y-1">
                      {selectionSort.explanation.advantages.map((advantage, index) => (
                        <li key={index} className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <ul className="text-sm text-gray-600 space-y-1">
                      {selectionSort.explanation.disadvantages.map((disadvantage, index) => (
                        <li key={index} className="flex items-start gap-2">
...
export default EnhancedSelectionSort;
